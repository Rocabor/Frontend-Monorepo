...
<template>
  <section id="sign-in" class="absolute w-84.5 top-792.5 md:w-120 md:top-890 inset-x-0 mx-auto xl:w-215.75 xl:top-731.25">
    <div
      class="bg-navy-850 px-6 py-10 md:px-10 md:py-12 rounded-[9px] text-center shadow-card 
    md:w-120 md:mx-auto xl:w-215.75 xl:px-20">
      <h2 class="text-preset-2 md:text-[clamp(1.25rem,calc(-0.179rem+2.976vw),2.50rem)] mb-4 xl:mb-2">
        Get early access today
      </h2>
      
      <p class="text-preset-3F max-w-2xl mx-auto mb-8 opacity-85">
        It only takes a minute to sign up and our free starter tier is extremely generous. If you have any questions, our support team would be happy to help you.
      </p>
      
      <form class="flex flex-col xl:flex-row gap-6 md:gap-4 items-start w-full xl:gap-6" @submit.prevent="handleSubmit">
        ...
        <BaseButton type="submit" class="w-full md:w-100 xl:w-50 text-[14px] leading-[1.2] xl:px-6">
