...
<template>
  <section id="journey-section" class="max-w-300 mx-auto px-6 pt-36 pb-24 relative z-10">
    <div class="mb-11 flex flex-col items-center text-center">
      <h2 :class="['title-gradient font-display text-3xl md:text-4xl font-extrabold uppercase tracking-[5px] m-0', activeCategory.toLowerCase()]">
        {{ activeCategory }}
      </h2>
      ...
      <div class="flex flex-wrap gap-3 mt-5 justify-center">
        <button
          :class="[
            ...
            sortOrder === 'newest' ? 'text-[#04141b] bg-linear-to-br from-primary to-primary-dark border-transparent' : 'border-white/10 bg-surface text-bright hover:text-[#04141b] hover:bg-linear-to-br hover:from-primary hover:to-primary-dark hover:border-transparent'
          ]"
        ...
        <button
          :class="[
            'px-5 py-2.5 rounded-lg border text-sm font-display font-bold cursor-pointer transition-all active:scale-95 focus-visible:scale-95',
            sortOrder === 'oldest' ? 'text-[#04141b] bg-linear-to-br from-primary to-primary-dark border-transparent' : 'border-white/10 bg-surface text-bright hover:text-[#04141b] hover:bg-linear-to-br hover:from-primary hover:to-primary-dark hover:border-transparent'
          ]"
        ...
        <button
          :class="[
            ...
            sortOrder === 'votes' ? 'text-[#04141b] bg-linear-to-br from-primary to-primary-dark border-transparent' : 'border-white/10 bg-surface text-bright hover:text-[#04141b] hover:bg-linear-to-br hover:from-primary hover:to-primary-dark hover:border-transparent'
          ]"
        ...
        <button
          :class="[
            'px-5 py-2.5 rounded-lg border text-sm font-display font-bold cursor-pointer transition-all active:scale-95 focus-visible:scale-95 inline-flex items-center gap-1.5',
            sortOrder === 'views' ? 'text-[#04141b] bg-linear-to-br from-primary to-primary-dark border-transparent' : 'border-white/10 bg-surface text-bright hover:text-[#04141b] hover:bg-linear-to-br hover:from-primary hover:to-primary-dark hover:border-transparent'
          ]"
    ...
    <div v-if="canLoadMore || canShowLess" class="flex justify-center mt-9">
      <button
        class="px-7 py-3 rounded-lg cursor-pointer font-display text-sm font-bold tracking-wide text-[#04141b] bg-linear-to-br from-primary to-primary-dark border-0 transition hover:brightness-110 hover:-translate-y-0.5 active:scale-95 active:translate-y-0 focus-visible:scale-95"
