...
<template>
  ...
  >
    <div class="relative h-[200px] overflow-hidden bg-surface-lowest">
      ...
      <div class="absolute left-0 right-0 bottom-0 z-2 p-4 flex flex-col gap-3 bg-gradient-to-t from-[rgba(10,14,18,0.92)] via-[rgba(10,14,18,0.55)] to-transparent opacity-0 translate-y-3 transition group-hover:opacity-100 group-hover:translate-y-0 max-sm:opacity-100 max-sm:translate-y-0" aria-hidden="true">
